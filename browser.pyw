...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Persia-Browser", self)
        about_action.setStatusTip("Find out more about Persia-Browser")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Persia-Browser" % title)
...
app.setApplicationName("Persia-Browser")
app.setOrganizationName("Persia")
